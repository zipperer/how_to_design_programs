...
; (cons 10 (cons 9 (cons 8 (cons 4 '())))) is a List-of-amountss

; Also add an arrow for the self-reference.
; - Arrow from List-of-amounts in second clause of data definition to name of data definition
...
(check-expect (sum (cons 10 (cons 9 (cons 8 (cons 4 '()))))) 31)
