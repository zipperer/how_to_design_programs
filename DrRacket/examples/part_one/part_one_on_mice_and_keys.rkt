...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname part_one_on_mice_and_keys) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
