...
Number = Union[int, float, complex] # alternatively int | float | complex
NumberOrFalse = Union[Number, Literal[False]]

# NumberOrFalse -> Number
# adds 3 to the given number; 3 otherwise

def add3 (number_or_false : NumberOrFalse) -> Number:
...
def add3_without_using_match_keyword(number_or_false : NumberOrFalse) -> Number:
